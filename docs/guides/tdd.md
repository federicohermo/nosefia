...
Lo que **no** vale es escribirlo como criterio de aceptación: uno que se cierra mirando no lo
cierra nadie —está medido: 137 casillas así en 35 specs del régimen viejo, 6 cerradas alguna
vez—. Si hay que playtestear algo, va al Backlog de Notion, que es donde el equipo mira lo que
no es código.
