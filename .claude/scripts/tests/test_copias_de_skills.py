...
#: `.claude/scripts/` porque se corre a mano. El resto —`sin-deuda.md`, `hallazgos.md` y
#: `diff_pr.py`— tiene su canónico en el skill que lo estrenó.
#:
...
#: otros casos: por eso está escrita acá y no en el nombre de una carpeta.
COPIAS: dict[Path, tuple[Path, ...]] = {
    SKILLS / "to-spec" / "sin-deuda.md": tuple(
