...
func test_el_surtido_fijo_no_muestra_stock_que_el_dominio_no_tiene() -> void:
	...
	for nombre in [
		...
		"gondolanueva2/chisitos2-2oeste2",
		"gondolanueva/chisitos2-fondo",
		"gondolanueva2/durextra-2este1",
		"gondolanueva2/durextra-fondo",
		...
		"macumbas-fondo",
		"gondolanueva2/malbardocig-2oeste0",
		"gondolanueva/malbardocig-fondo",
		...
		"gondolanueva/snackpapas1-fondo",
