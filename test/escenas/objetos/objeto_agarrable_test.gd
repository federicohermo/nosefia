...
## `is_in_group` contesta bien afuera del árbol. Dos casos sí la entran y lo explican adentro:
## el del reposo, que pide pasos de física, y el de la interpolación, que pide lo que se dibuja.
