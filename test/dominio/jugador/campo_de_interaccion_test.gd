...
func test_el_techo_angular_se_acepta() -> void:  # AC-PLY-004
...
func test_un_grado_sobre_el_techo_se_rechaza() -> void:  # AC-PLY-004
...
func test_el_centrado_gana_a_un_candidato_mas_cercano() -> void:  # AC-PLY-005
...
func test_a_igual_desvio_gana_el_mas_cercano() -> void:  # AC-PLY-005
...
func test_el_limite_de_alcance_se_acepta() -> void:  # AC-PLY-004
	var candidato := Campo.Candidato.new(1, ReglasDelJugador.ALCANCE_DE_LA_MIRA, 0.0, true, true)
	assert_int(Campo.elegir([candidato])).is_equal(1)


func test_un_centimetro_fuera_del_alcance_se_rechaza() -> void:  # AC-PLY-004
